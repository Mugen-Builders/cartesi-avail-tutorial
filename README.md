...
- Download the Cartesi machine for your OS from this link: \[[https://github.com/edubart/cartesi-machine-everywhere/releases](https://github.com/edubart/cartesi-machine-everywhere/releases)\].
...
` wss://[turing-rpc.avail.so/ws](http://turing-rpc.avail.so/ws)`. Then the Mnemonics should be for a wallet that has sufficient Avail test tokens which **_nonodo_** will be using to relay your transactions to the avail network.
...
- To send data via avail use the “Send L2 EIP-712 Inpu” form in the Input section.
